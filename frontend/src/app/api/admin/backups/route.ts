...
export async function GET(request: NextRequest) { return proxy(request, '/api/admin/backups'); }
export async function POST(request: NextRequest) { return proxy(request, '/api/admin/backups', 'POST'); }
