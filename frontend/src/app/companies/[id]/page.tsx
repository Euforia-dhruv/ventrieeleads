...
export default function CompanyDetailPage() {
  ...
  if (!company) return <div className="p-6 text-center text-[hsl(215,16%,40%)]">Company not found</div>;
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {company.lead_score !== undefined && (
              <div className="text-center p-3 bg-white/[0.02] rounded-lg">
                <div className={cn('text-[24px] font-bold', getScoreColor(company.lead_score))}>
                  {company.lead_score}
                </div>
            ...
            {company.website_score !== undefined && (
              <div className="text-center p-3 bg-white/[0.02] rounded-lg">
                <div className={cn('text-[24px] font-bold', getScoreColor(company.website_score))}>
            ...
            {company.opportunity_score !== undefined && (
              <div className="text-center p-3 bg-white/[0.02] rounded-lg">
                <div className={cn('text-[24px] font-bold', getScoreColor(company.opportunity_score))}>
          ...
          {company.technologies && company.technologies.length > 0 && (
            <div className="glass-card rounded-xl p-5">
              ...
              <div className="flex flex-wrap gap-1.5">
                {company.technologies.map((t: { name?: string } | string, i: number) => (
                  <span
                    key={i}
                    className="px-2 py-0.5 bg-white/[0.04] border border-white/[0.06] rounded text-[10px] text-[hsl(215,20%,60%)]"
                  >
