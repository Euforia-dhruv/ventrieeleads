...
import { User, Key, Shield, Bell, LogOut, Save, Loader2, Plus, Trash2, Copy, Eye, EyeOff } from 'lucide-react';
  ...
  return (
    <div className="p-6 max-w-[800px] mx-auto space-y-6">
        ...
        <div className="space-y-4">
          ...
          {showNewKey && (
            <div className="glass-card rounded-xl p-4 border-green-500/20 bg-green-500/5">
              <p className="text-[11px] text-green-400 font-medium mb-2">New API key created. Copy it now — it won't be shown again.</p>
              <div className="flex items-center gap-2">
                <code className="flex-1 p-2 bg-black/30 rounded text-[12px] text-green-300 font-mono break-all">{showNewKey}</code>
      ...
      {activeTab === 'password' && (
        <div className="glass-card rounded-xl p-6 space-y-4">
          <div>
            <label className="text-[11px] font-medium text-[hsl(215,16%,50%)] uppercase tracking-wider">Current Password</label>
            <input
          ...
          <div>
            <label className="text-[11px] font-medium text-[hsl(215,16%,50%)] uppercase tracking-wider">New Password</label>
            <input
          ...
          <button
            onClick={changePassword} disabled={saving || !currentPassword || !newPassword}
            className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-500 disabled:bg-[hsl(223,47%,11%)] disabled:text-[hsl(215,16%,35%)] text-white rounded-lg text-[13px] font-medium transition-all"
          >
