...
const navItems = [
  ...
  { href: '/prospects', label: 'Best Prospects', icon: Trophy },
      ...
      >
        ...
        <div className="p-3 border-t border-white/[0.04]">
          {isAuthenticated && user ? (
            ...
            <Link
              href="/login"
              className="flex items-center gap-3 px-3 py-2 rounded-lg text-[13px] font-medium text-[hsl(215,16%,40%)] hover:bg-white/[0.04] hover:text-white transition-all"
            >
              <User className="h-4 w-4" />
              Sign In
            </Link>
          )}
          <div className="text-[10px] text-[hsl(215,16%,28%)] mt-2 px-3">v4.0</div>
        </div>
      </aside>
